...
export const CITY_PAGES: CityPage[] = [
  /* ─────────────────────── 01 LUCKNOW ─────────────────────── */
  {
    ...
    campaigns: [
      { brand: "HDFC Bank", format: "Large Hoarding × 8", area: "Hazratganj, Gomti Nagar", year: "2024", accent: "#004C8F" },
      { brand: "Nestlé", format: "Auto Branding × 50", area: "City-wide", year: "2023", accent: "#D2232A" },
      ...
      { brand: "Campus", format: "Auto + Bus Branding", area: "Alambagh, Charbagh", year: "2023", accent: "#E67E22" },
    ],
    office: {
      person: "Narjis",
  ...
  /* ─────────────────────── 02 KANPUR ─────────────────────── */
  {
    ...
    campaigns: [
      ...
      { brand: "Campus Shoes", format: "Bus Branding × 12", area: "All city routes", year: "2023", accent: "#E67E22" },
      { brand: "Pan Bahar", format: "Unipole × 2 + Gantry × 1", area: "NH-19, Outer Ring Road", year: "2024", accent: "#C0392B" },
      { brand: "HDFC Bank", format: "Hoarding × 5", area: "Mall Road, Kidwai Nagar", year: "2023", accent: "#004C8F" },
    ],
    office: {
      person: "Khushi",
  ...
  /* ─────────────────────── 03 DELHI ─────────────────────── */
  {
    ...
    campaigns: [
      { brand: "Vaseline", format: "Metro Pillar Branding", area: "South Delhi stations", year: "2024", accent: "#0068A7" },
      { brand: "HDFC Bank", format: "Hoarding × 10 + LED", area: "Ring Road, CR Park, GK", year: "2024", accent: "#004C8F" },
      { brand: "Nestlé", format: "Bus Branding × 20", area: "South & Central Delhi routes", year: "2023", accent: "#D2232A" },
      { brand: "NINE", format: "Auto Branding × 30", area: "South Delhi", year: "2024", accent: "#8E44AD" },
  ...
  /* ─────────────────────── 04 BHOPAL ─────────────────────── */
  {
    ...
    campaigns: [
      { brand: "Nestlé", format: "Auto Branding × 40", area: "City-wide", year: "2024", accent: "#D2232A" },
      { brand: "HDFC Bank", format: "Hoarding × 5", area: "MP Nagar, TT Nagar", year: "2023", accent: "#004C8F" },
      ...
      { brand: "Campus", format: "Bus Branding × 10", area: "All city routes", year: "2023", accent: "#E67E22" },
    ],
    office: {
      person: "Syed Iqbal",
  ...
  /* ─────────────────────── 05 AGRA ─────────────────────── */
  {
    ...
    campaigns: [
      ...
      { brand: "HDFC Bank", format: "Hoarding × 4", area: "Sanjay Place, MG Road", year: "2023", accent: "#004C8F" },
      { brand: "Nestlé", format: "Auto Branding × 30", area: "Tourist triangle + city", year: "2024", accent: "#D2232A" },
      { brand: "Campus", format: "Hoarding × 3 + Bus × 5", area: "City-wide", year: "2023", accent: "#E67E22" },
  ...
  /* ─────────────────────── 06 PRAYAGRAJ ─────────────────────── */
  {
    ...
    campaigns: [
      { brand: "Nestlé", format: "Auto Branding × 25", area: "City-wide", year: "2024", accent: "#D2232A" },
      { brand: "HDFC Bank", format: "Hoarding × 3", area: "Civil Lines, MG Marg", year: "2023", accent: "#004C8F" },
      ...
      { brand: "Campus", format: "Bus Branding × 8", area: "All city routes", year: "2023", accent: "#E67E22" },
    ],
    office: {
